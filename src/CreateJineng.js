...
(function(_Sprite){
    ...
    _proto.init = function(name,speed,attack,time){
        ...
        if(!isCache){
            ...
            //赵云
            Laya.Animation.createFrames(['pic/zidan2.png'],'赵云_jineng1');
            Laya.Animation.createFrames(['pic/shuijuan.png'],'赵云_jineng2');
            ...
            //典韦
            Laya.Animation.createFrames(['pic/zidan.png'],'典韦_jineng1');
            //曹仁
            Laya.Animation.createFrames(['pic/zidan2.png'],'曹仁_jineng1');
            ...
            Laya.Animation.createFrames(['pic/longjuan.png'],'张辽_jineng2');
